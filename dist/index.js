...
function createFormContext(initialState) {
    ...
    const result = {
        Provider: (_a) => {
            var { children, defaultValues } = _a, formProps = __rest(_a, ["children", "defaultValues"]);
            const methods = useForm(Object.assign(Object.assign({}, formProps), { defaultValues: Object.assign(Object.assign({}, initialState), defaultValues) }));
            return (jsxRuntimeExports.jsx(Context.Provider, Object.assign({ value: methods }, { children: jsxRuntimeExports.jsx(FormProvider, Object.assign({}, methods, { children: children })) })));
        },
        context: Context,
        ...
        useFormState: function (options) {
            ...
            const state = useFormState(Object.assign({ control }, options));
            return state;
        },
        ...
        Controller: function (_a) {
            ...
            const context = reactExports.useContext(Context);
            return jsxRuntimeExports.jsx(Controller, Object.assign({}, rest, { control: context.control, name: name }));
        },
        withFormProvider: function (Component, formProps) {
            return (props) => {
                const Provider = this.Provider;
                return (jsxRuntimeExports.jsx(Provider, Object.assign({}, formProps, { children: jsxRuntimeExports.jsx(Component, Object.assign({}, props)) })));
            };
        },
    };
    return result;
